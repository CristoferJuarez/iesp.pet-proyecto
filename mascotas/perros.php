...
// Consultamos solo los perros desde la base de datos
try {
    $sql = "SELECT * FROM mascotas WHERE especie = 'Perro' ORDER BY id ASC";
    $stmt = $pdo->query($sql);
    $mascotas = $stmt->fetchAll();
} catch (\PDOException $e) {
    error_log("Error al consultar perros: " . $e->getMessage());
    $mascotas = [];
}
?>
...
<main class="main-content">
    <section class="catalogo-section">
        <div class="catalogo-header">
            <h2><i class="fa-solid fa-dog"></i> Nuestros Perritos en Adopción</h2>
            <p>Conoce a los caninos que están buscando un hogar responsable en Trujillo.</p>
        </div>
                    ...
                    <div class="tarjeta-mascota <?php echo !$mascota['disponible'] ? 'en-proceso' : ''; ?>">
                        ...
                        <div class="mascota-info">
                            <div class="mascota-header-tarjeta">
                                ...
                                <span class="especie-tag"><i class="fa-solid fa-dog"></i> <?php echo $mascota['especie']; ?></span>
                            </div>
